...
def next_move_straight_line(hunter_position, hunter_heading, target_measurement, max_distance, OTHER = None):
    ...
    if OTHER is None:
        ...
        if len(coords) == 1:
            ...
            # chord  calculation which is the distance for one step
            #distance = 2 * radius * sin(turning/2) # in this case, avgDT is better than this
            ...
            #print "avgDT", avgDT, "distance", distance # avgDT is closer to the truth
            #avgAngle = sum(angles)/len(angles)
            #print "avgAngle", avgAngle, "turning", turning, "actual", 2*pi / 30 # turning is slightly better than avgAngle
            ...
            # estimated_x = xc + radius * cos(ukf.x[2])
            # estimated_y = yc + radius * sin(ukf.x[2])
...
# This is slightly better than RR4_UKF

# Counterclockwise:
# average score:  57.379
# minimum score:  21
# maximum score:  310
# fails:  0
