...
# Ilya:
# This is an extension of RR5_Least_squares_6.py
...
def getTurningAndHeading(measurements, rotationSign, radius, xc, yc):
    ...
    mean_of_all_angles = mean_angle(total_angles)

    # if even
    if number_of_steps % 2 == 0:
        print "even"
        startingHeading = mean_of_all_angles - ( (( 0.5 * number_of_steps  - 1) * turning) + 0.5 * turning )
    # if odd
    else:
